...
class DeepNeuralNetworkModel:
    def __initialize_parameters_deep(self, layer_dims):
        """
        Arguments:
    ...
    def __L_model_backward(self, AL, Y, caches):
        ...
        for l in reversed(range(L - 1)):
            ...
            # "grads["dA" + str(l)] , grads["dW" + str(l + 1)] , grads["db" +
            # str(l + 1)]
    ...
    def __update_parameters(slef, parameters, grads, learning_rate):
        """
    ...
    def predict(self, X, y, parameters):
        ...
        # Forward propagation
        probas, caches = self.__L_model_forward(X, parameters)
